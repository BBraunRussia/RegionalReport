...
namespace System.Windows.Forms.Calendar
{
    ...
    public class CalendarRenderer
    {
        ...
        public int GetTimeY(TimeSpan time)
        {
            ...
            double totalmins = time.TotalMinutes - 420;
            ...
            if (Calendar.DaysMode == CalendarDaysMode.Expanded)
            {
                ...
                foreach (CalendarItem item in Calendar.Items)
                {
                    ...
                    else
                    {
                        ...
                        int indexStart = Convert.ToInt32(Math.Floor((date1.TimeOfDay.TotalMinutes - 420) / unitDurationMinutes));
                        int indexEnd = Convert.ToInt32(Math.Ceiling((date2.TimeOfDay.TotalMinutes - 420) / unitDurationMinutes));
