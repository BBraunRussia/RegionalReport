        ...
        : ScrollableControl
    {
        ...
        public Calendar()
        {
            ...
            HighlightRanges = new CalendarHighlightRange[] { 
                new CalendarHighlightRange( DayOfWeek.Monday, new TimeSpan(10,0,0), new TimeSpan(19,0,0)),
                new CalendarHighlightRange( DayOfWeek.Tuesday, new TimeSpan(10,0,0), new TimeSpan(19,0,0)),
                new CalendarHighlightRange( DayOfWeek.Wednesday, new TimeSpan(10,0,0), new TimeSpan(19,0,0)),
                new CalendarHighlightRange( DayOfWeek.Thursday, new TimeSpan(10,0,0), new TimeSpan(19,0,0)),
                new CalendarHighlightRange( DayOfWeek.Friday, new TimeSpan(10,0,0), new TimeSpan(19,0,0)),
            };
        ...
        /// </summary>
        [DefaultValue(CalendarTimeScale.SixtyMinutes)]
        ...
        {
            if ((SelectedElementEnd == null) || (SelectedElementStart == null) || (SelectedElementStart.Date.Hour == 20) || (SelectedElementStart.Date.Hour == 0))
                return;
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            if ((hitted != null) && (hitted.Date.Hour >= 7) && (hitted.Date.Hour <= 19))
            {
                switch (State)
                {
                    case CalendarState.Idle:
                    ...
                    case CalendarState.DraggingItem:
                        ...
                        DateTime dateTemp = itemOnState.StartDate;
                        ...
                        if (itemOnState.EndDate.Hour > 20)
                        {
                            itemOnState.StartDate = dateTemp;
                            itemOnState.EndDate = dateTemp.Add(duration);
                            return;
                        }
