...
namespace System.Windows.Forms.Calendar
{
        ...
        : CalendarSelectableElement
    {
        ...
        public CalendarItem(Calendar calendar, DateTime startDate, DateTime endDate, string text, string id)
            : this(calendar)
        {
            StartDate = startDate;
            EndDate = endDate;
        ...
        /// <param name="text">Text of the item</param>
        public CalendarItem(Calendar calendar, DateTime startDate, TimeSpan duration, string text, string id)
            : this(calendar, startDate, startDate.Add(duration), text, id)
        { }
